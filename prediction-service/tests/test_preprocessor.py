...
def test_single_field_no_group():
    series_map, warnings = build_series_map(_BASE_RECORDS, "date", _TARGETS, None, "ME")
...
def test_values_correct():
    series_map, _ = build_series_map(_BASE_RECORDS, "date", _TARGETS, None, "ME")
...
def test_multiple_target_fields():
    ...
    series_map, _ = build_series_map(records, "date", targets, None, "ME")
    assert ("sales", None) in series_map
...
def test_group_field_creates_separate_series():
    ...
    series_map, _ = build_series_map(records, "date", _TARGETS, "produto", "ME")
...
def test_aggregation_sum():
    ...
    series_map, _ = build_series_map(records, "date", _TARGETS, None, "ME")
...
def test_skips_invalid_date():
    ...
    series_map, warnings = build_series_map(records, "date", _TARGETS, None, "ME")
    assert ("sales", None) in series_map
...
def test_skips_invalid_value():
    ...
    _, warnings = build_series_map(records, "date", _TARGETS, None, "ME")
